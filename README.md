...
My college class had a straightforward requirement: build some tech idea (which eventually boiled down to mobile or web app) over one semester. Four quarters—design, data implementation, feature development, polish.
